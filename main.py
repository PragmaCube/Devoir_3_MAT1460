...
# de la densité de voitures sur la route et de leur disposition :
...
# éviter les collisions (attention, vers 75 voitures cela 
# commence à être très aléatoire). C'est aussi correct et
# pour la même raison (mais dans l'autre sens).
...
# sont en collisions dès l'itération 1 et pendant près de la
# moitié de la simulation).
...
while True:
    ...
    # On s'assure de commencer le programme en ayant aucune collision.
